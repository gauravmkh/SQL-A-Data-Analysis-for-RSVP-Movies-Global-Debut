...
-- COUNT THE NUMBER OF NULLS IN EACH COLUMN USING CASE STATEMENT
SELECT Sum(CASE
...
-- HIGHEST NUMBER OF MOVIES WERE RELEASED IN 2017 IN MONTH OF 3
...
-- 361 MOVIES RELEASED BETWEEN 2018 AND 2019 
...
-- GERMAN MOVIE RECEVIED MORE VOTES THAN ITALY
...
-- HEIGHT, DATE_OF_BInamesRTH, KNOWN_FOR_MOVIES ARE CONTAIN NULL VALUES
...
-- JAMES MANGOLD, ANTHONY RUSS AND SOUBIN  SHAHIR ARE TOP THREE DIRECTORS IN THE TOP THREE GENRES WHOSE MOVIES HAVE AN AVERAGE RATING > 8
...
-- TOP THREE PRODUCTION HOUSES BASED ON THE NUMBER OF VOTES RECEVIED BY THEIR MOVIES ARE MARVEL STUDIOS, TWENTIETH CENTURY FOX AND WARNER BROS.
...
-- TOP FIVE ACTRESS IN HINDI MOVIES RELEASED IN INDIA BASED ON THEIR AVERAGE RATING

/* SHRIDDHA SRINATH tops with average rating 8.48. 
...
SELECT *,
        CASE 
           WHEN avg_rating > 8 THEN 'SUPPER HIT MOVIES'
